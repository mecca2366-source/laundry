                ...
                while($t=mysqli_fetch_array($transaksi)){
                    ...
                    <form method="post" action="transaksi_update.php">
                        ...
                        <div class="from-group">
                            ...
                            <select class="from-control" name="pelanggan" required="required">
                        ...
                        <div class="form-group">
                            <label>Berat</label>
                            <input type="number" class="form-control" name="berat" placeholder="Masukan berat Cucian .." required= "required"  value="<?php echo $t['transaksi_baret']; ?>">
                        </div>
